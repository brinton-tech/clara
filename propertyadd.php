...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,ptype,stype,price,city,state,pimage)
	values('$title','$ptype','$stype','$price',
	'$city','$state','$aimage')";
									...
									<?php echo $msg; ?>
										...
										<div class="col-xl-12">
												<div class="form-group row">
													<label class="col-lg-2 col-form-label" hidden>ID</label>
													<div class="col-lg-6">
														<input type="number" class="form-control" name="pid"  placeholder="Enter ID" hidden>
													</div>
												</div>
